...
def compare_engagement_levels(df):
    ...
    result_df = df.groupBy("JobTitle") \
                  ...
                  .orderBy("AvgEngagementLevel", ascending=False)  # Sort by highest engagement level
...
def main():
    ...
    output_file = "/workspaces/spark-structured-api-employee-engagement-analysis-maroofansari2310/outputs/task3/engagement_levels_job_titles.csv"
